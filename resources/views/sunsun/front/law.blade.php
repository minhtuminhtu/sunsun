        ...
        <div class="booking mb-4">
            <div class="booking-warp index">
                <div id="law">
                    ...
                    <p>営業時間： 9:30〜20:30　定休日：水曜日、木曜日</p>
                    <h3>商品価格</h3>
                    <p>商品価格は、表示された金額（表示価格/消費税込）と致します。</p>
                    <h3>代金清算方法</h3>
                    <p>・フロントにて精算：現金またはクレジットカード</p>
                    <p>・クレジットカードにて事前精算：オンライン予約完了時にクレジットカードで一括お支払
（カード会社からのご請求はご出発日基準になります）</p>
                    <h3>引渡時期（予約成立時期）</h3>
                    ...
                    <h3>キャンセル料</h3>
                    <p>・宿泊日前日のキャンセル 宿泊料金の20％</p>
                    <p>・宿泊日当日のキャンセル 宿泊料金の80％</p>
                    <p>・無連絡の不泊 宿泊料金の100％</p>
                    <p>※宿泊プランにより条件が変更になる場合がございます。</p>
                </div>
            </div>
        </div>
    </main>
