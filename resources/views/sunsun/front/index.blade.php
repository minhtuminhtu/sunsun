                    ...
                    <div class="row">
                        ...
                        <div class="col-7">
                            <div class="row carousel-warp">
                                <div class="col-10">
                                    <input data-format="yyyy/MM/dd" type="text" class="form-control mt-3 date-book-input" id="pwd" value="2019/9/20(金)" />
                                </div>

                                <div class="col-2 pl-0 ">
                                     <span class="add-on">
                                      <i data-time-icon="icon-time" data-date-icon="icon-calendar" class="fa fa-calendar-alt fa-2x  mt-3" id="date-book"></i>
                                    </span>
                                </div>
                            </div>
                        </div>
