    ...
    <main class="container">
        ...
        <div class="main-content">
            ...
            @foreach($time_range as $key => $time)
                ...
                <div class="weekly">
                    <div class="weekly-time body-content last content">
                        <div class="time">{{ $time['time'] }}</div>
                        <div class="time_range">{{ '(' . $time['time_range'] . ')' }}</div>
                    </div>
                    <div class="weekly-table">
                ...
                <div class="weekly">
                    <div class="body-free">
                        <div class="begin_time first_time"></div>
                    </div>
                    <div class="weekly-table">
                        <div class="table-header">
                            @foreach($day_range as $day)
                                @if(($day['week_day'] != '水') && ($day['week_day'] != '木'))
                                    @if(($day['week_day'] == '月') || ($day['week_day'] == '土'))
                                        <div class="table-col begin_time">{{ $time['begin_time'] }}</div>
                                    @elseif(($day['week_day'] == '火') || ($day['week_day'] == '日'))
                                        <div class="table-col begin_time last_time"></div>
                                    @elseif($day['week_day'] == '金')
                                        <div class="table-col begin_time first_time"></div>
                                    @else
                                        <div class="table-col begin_time"></div>
                                    @endif
                                @elseif($day['week_day'] == '水')
                                    <div class="table-col-none begin_time_free"></div>
                                @endif
                            @endforeach
                        </div>
                    </div>
