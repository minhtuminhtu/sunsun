      ...
      */
      public function run()
      {
            ...
            VALUES
                  ...
                  ,('030', '04', '1200食', '4', 'ランチ')
                  ,('030', '05', '8500人', '5', '１日リフレッシュプラン')
                  ,('030', '06', '22000回', '6', '酵素部屋１部屋貸切プラン')
                  ,('030', '07', '3300人', '7', '酵素部屋１部屋貸切プラン（追加）')
            ...
            DB::insert("
                ...
                VALUES
                        ...
                        ('021','01','10:00～10:30','1','1000-1030|1','1000'),
                        ...
                        ('021','06','13:00～13:30','6','1300-1330|0','1300'),
                        ('021','07','13:30～14:00','7','1330-1400|0','1330'),
                        ('021','08','14:00～14:30','8','1400-1430|1','1400'),
                        ('021','09','15:00～15:30','9','1500-1530|0','1500'),
                        ('021','10','15:30～16:00','10','1530-1600|1','1530'),
                        ('021','11','16:30～17:00','11','1630-1700|0','1630')
            ");
      }
}
