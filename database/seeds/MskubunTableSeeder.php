      ...
      public function run()
      {
            ...
            DB::insert("
                ...
                VALUES
                        ...
                        ,('031', '02', '3000回', '2', '酵素浴（学生）')
                        ,('031', '03', '2300回', '3', '酵素浴（小学生）')
                        ,('031', '04', '1200名', '15', 'ランチ')
                        ,('031', '05', '10000名', '4', '朝からリフレッシュコース')
                        ,('031', '06', '23400回', '9', '酵素部屋１部屋貸切プラン')
                        ,('031', '07', '3500名', '10', '酵素部屋１部屋貸切プラン（追加）')
                        ,('031', '08', '12800回', '11', '断食コース（1日コース）')
                        ,('031', '09', '68000回', '12', '断食コース（5日間体質改善コース ）')
                        ,('031', '10', '12000泊', '25', 'レンタルルーム（デラックスルーム、1名）')
                        ,('031', '11', '12000泊', '27', 'レンタルルーム（デラックスルーム、2名）')
                        ,('031', '12', '7700泊', '23', 'レンタルルーム（ツイン、1名）')
                        ,('031', '13', '12000泊', '24', 'レンタルルーム（ツイン、2名）')
                        ,('031', '14', '7700泊', '21', 'レンタルルーム（シングル、1名）')
                        ,('031', '15', '600名', '29', 'モーニング')
                        ,('031', '16', '3900回', '13', 'ペット酵素浴')
                        ,('031', '17', '2500回', '14', 'ペット酵素浴（1匹追加）')
                        ,('031', '18', '500回', '19', 'ペット預かり（酵素浴1回）')
                        ,('031', '19', '1000回', '20', 'ペット預かり（リフレッシュプラン）')
                        ,('031', '20', '3900回', '16', 'ニュースキャン')
                        ,('031', '21', '10000名', '6','お昼からのスイーツコース')
                        ,('031', '22', '8800名', '7','美肌コース')
                        ,('031', '23', '7500名', '8','免疫力アップコース')
                        ,('031', '24', '10000名', '5','お昼からリフレッシュコース')
                        ,('031', '25', '11000泊', '26','レンタルルーム（デラックスルーム、1名）')
                        ,('031', '26', '11000泊', '28','レンタルルーム（デラックスルーム、2名）')
                        ,('031', '27', '7000泊', '22','レンタルルーム（シングル、1名）')
