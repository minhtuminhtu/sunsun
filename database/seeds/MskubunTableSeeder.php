      ...
      */
      public function run()
      {
            ...
            VALUES
                  ...
                  ,('030', '04', '1200名', '4', 'ランチ')
                  ,('030', '05', '10000名', '5', '朝からリフレッシュコース')
                  ,('030', '06', '22000回', '6', '酵素部屋１部屋貸切プラン')
                  ,('030', '07', '3300名', '7', '酵素部屋１部屋貸切プラン（追加）')
                  ,('030', '08', '12000回', '8', '断食プラン（1日プラン）')
                  ,('030', '09', '65000回', '9', '断食プラン（体質改善5日間コース ）')
                  ,('030', '10', '7700泊', '10', 'レンタルルーム（畳、1名）')
                  ,('030', '11', '12000泊', '11', 'レンタルルーム（畳、2名）')
                  ,('030', '12', '7700泊', '12', 'レンタルルーム（ツイン、1名）')
                  ,('030', '13', '12000泊', '13', 'レンタルルーム（ツイン、2名）')
                  ,('030', '14', '7700泊', '14', 'レンタルルーム（シングル、1名）')
                  ...
                  ,('030', '20', '3500回', '20', 'ニュースキャン')
                  ,('030', '21', '10000名', '21','お昼からのスイーツコース')
                  ,('030', '22', '8500名', '22','美肌コース')
                  ,('030', '23', '7500名', '23','免疫力アップコース')
                  ,('030', '24', '10000名', '24','お昼からリフレッシュコース')
                  ,('030', '25', '7000泊', '25','レンタルルーム（デラックスルーム、1名）')
                  ,('030', '26', '11000泊', '26','レンタルルーム（デラックスルーム、2名）')
                  ,('030', '27', '7000泊', '27','レンタルルーム（シングル、1名）')
                  ,('030', '28', '3500名', '28','ホワイトニング')
            ");
            DB::insert("
