...
$(function () {
  ...
  $('#go-weekly').on('click', function (e) {
    ...
    var start_weekly = moment(weekStart).add(0, 'days').format("YMMDD");
    var end_weekly = moment(weekStart).add(6, 'days').format("YMMDD");
    var weekly_url = $curent_url.substring(0, $curent_url.length - 3) + "weekly";
  ...
  $('#go-monthly').on('click', function (e) {
    ...
    var monthly_url = $curent_url.substring(0, $curent_url.length - 3) + "monthly";
    window.location.href = monthly_url + "?date=" + monthly;
  });
  $('#go-user').off('click');
  $('#go-user').on('click', function (e) {
    var user_url = $curent_url.substring(0, $curent_url.length - 9) + "admin/msuser";
