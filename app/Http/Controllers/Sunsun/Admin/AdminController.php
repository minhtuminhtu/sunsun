...
class AdminController extends Controller
{
	...
	private function getSelect_search($course, $type = "") {
		$select = "";
		switch ($course) {
			case '02': case '07': case '08': case '09':
	...
	private function set_course(&$data, $date, $time_value){
		...
		for($i = 0; $i < count($course_1_to_4); $i++){
			switch($course_1_to_4[$i]->course){
				...
				case '07': $course_1_to_4[$i]->course = '昼り'; break;
				case '08': $course_1_to_4[$i]->course = '美'; break;
				case '09': $course_1_to_4[$i]->course = '免疫'; break;
			}
		...
		for($i = 0; $i < count($course_wt); $i++){
			...
			switch($course_wt[$i]->course){
				...
				case '07': $course_wt[$i]->course = '昼り'; break;
				case '08': $course_wt[$i]->course = '美'; break;
				case '09': $course_wt[$i]->course = '免疫'; break;
			}
		...
		public function show_history(Request $request){
			...
			for($i = 0; $i < count($history_booking); $i++){
				switch($history_booking[$i]->course){
					...
					case '07': $history_booking[$i]->course = '昼り'; break;
					case '08': $history_booking[$i]->course = '美'; break;
					case '09': $history_booking[$i]->course = '免疫'; break;
				}
